...
public class MapsActivity4 extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayer = MediaPlayer.create(getApplicationContext(), R.raw.musikbenteng);
...
//                }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(-7.8002713, 110.3662998);
        mMap.addMarker(new MarkerOptions().position(sydney).title("Benteng Vredeburg"));
